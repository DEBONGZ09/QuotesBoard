...
public class DeiverdFragment extends Fragment {
    //defining views
    private RecyclerView RecycleViewChats;
    ProgressBar qloader;
    private RecyclerView comrecyclerView;
    private AdapterDelivered mAdapter;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.frag_deliverd, container, false);
    }
...
//        buttonDisplayToken = (Button) getView().findViewById(R.id.buttonDisplayToken);
    ...
    private void fetchQuotes() {
        ...
        StringRequest sstringRequest = new StringRequest(Request.Method.GET, EndPoints.URL_FETCH_DELIVERED,
                    ...
                    public void onResponse(String result) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < jArray.length(); i++) {
                                ...
                                proData.order_cust_area = json_data.getString("customer_addr");
                            ...
                            mAdapter = new AdapterDelivered(getContext(),data);
