...
public class AsignToTab extends AppCompatActivity {
    ...
    String ServerUploadPath ="http://nextld.co.za/salesadmin/app/savetosig.php" ;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_asign_to_tab);
        getSupportActionBar().hide();

        sigimg = (ImageView)findViewById(R.id.sigimgto);
        mSignaturePad = (SignaturePad) findViewById(R.id.signature_padto);
        ...
        mClearButton = (Button) findViewById(R.id.clear_buttonto);
        mSaveButton = (Button) findViewById(R.id.save_buttonto);
...
//        byte[] byteArrayVar = byteArrayOutputStreamObject.toByteArray();
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected void onPostExecute(String string1) {
                ...
                Intent intent = new Intent(AsignToTab.this, MainActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
                finish();
                // Printing uploading success message coming from server on android app.
                Toast.makeText(AsignToTab.this, string1, Toast.LENGTH_LONG).show();
