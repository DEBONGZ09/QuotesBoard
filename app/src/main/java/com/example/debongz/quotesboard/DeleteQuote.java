...
//        byte[] byteArrayVar = byteArrayOutputStreamObject.toByteArray();
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected void onPostExecute(String string1) {
                ...
                Intent intent = new Intent(DeleteQuote.this, MainActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                intent.putExtra("q_number", q_number);
                startActivity(intent);
                // Printing uploading success message coming from server on android app.
                Toast.makeText(DeleteQuote.this, string1, Toast.LENGTH_LONG).show();
            ...
            protected String doInBackground(Void... params) {
                ...
                DeleteQuote.ImageProcessClass imageProcessClass = new DeleteQuote.ImageProcessClass();
                ...
                String FinalData = imageProcessClass.ImageHttpRequest(EndPoints.ServerUploadPathDel, HashMapParams);
