...
//        buttonDisplayToken = (Button) getView().findViewById(R.id.buttonDisplayToken);
    ...
    private void fetchQuotes() {
        ...
        StringRequest sstringRequest = new StringRequest(Request.Method.GET, EndPoints.URL_FETCH_OPEN,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String result) {
                        ...
                        try {
                            ...
                            mAdapter = new AdapterOpen(getContext(),data);
